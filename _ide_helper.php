 ...
 * Generated for Laravel 5.4.32 on 2017-08-21.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function success($message, $data = array(), $statusCode = 200, $headers = array())
        {
            return \Illuminate\Routing\ResponseFactory::success($message, $data, $statusCode, $headers);
        }
         ...
         * @static 
         */ 
        public static function error($message, $errors = array(), $statusCode = 500, $headers = array())
        {
            return \Illuminate\Routing\ResponseFactory::error($message, $errors, $statusCode, $headers);
        }
         ...
         * @static 
         */ 
        public static function notfound($data, $errors = array(), $statusCode = 404, $headers = array())
        {
            return \Illuminate\Routing\ResponseFactory::notfound($data, $errors, $statusCode, $headers);
        }
